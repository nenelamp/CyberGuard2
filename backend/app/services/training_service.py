#!/usr/bin/env python3
"""
Training service for initializing default training data for new users
"""
...
class TrainingService:
    """Service for initializing default training data for new users"""
    
    @staticmethod
    async def initialize_default_training_data(user_email: str):
        ...
        # Insert default training scores for new user
        for module in default_modules:
